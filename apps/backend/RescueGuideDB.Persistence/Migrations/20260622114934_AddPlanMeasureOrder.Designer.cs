...
namespace RescueGuideDB.Persistence.Migrations
{
    ...
    [Migration("20260622114934_AddPlanMeasureOrder")]
    partial class AddPlanMeasureOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RescueGuideDB.Core.Entities.PlanMeasure", b =>
                {
                    ...
                    b.HasKey("PlanId", "MeasureId");

                    b.HasIndex("MeasureId");

                    b.ToTable("PlanMeasures");
                });
            ...
            modelBuilder.Entity("RescueGuideDB.Core.Entities.PlanMeasure", b =>
                {
                    b.HasOne("RescueGuideDB.Core.Entities.Measure", "Measure")
                        .WithMany("PlanMeasures")
                        .HasForeignKey("MeasureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RescueGuideDB.Core.Entities.Plan", "Plan")
                        .WithMany("PlanMeasures")
